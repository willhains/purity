...
public @Pure interface SingleNumber<This extends SingleNumber<This>> extends SingleComparable<This>
{
	...
	default boolean isGreaterThanOrEqualTo(final Supplier<? extends Number> number)
	{
		return isGreaterThanOrEqualTo(number.get());
	}
	default boolean isLessThan(final Supplier<? extends Number> number) { return isLessThan(number.get()); }
	default boolean isLessThanOrEqualTo(final Supplier<? extends Number> number)
	{
		return isLessThanOrEqualTo(number.get());
	}
