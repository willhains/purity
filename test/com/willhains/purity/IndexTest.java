...
public class IndexTest
{
	...
	{
		final Index<String, Integer> x = Index.of("a", 1);
		final Index<String, Integer> y = x.set("b", 2);
		final Index<String, Integer> z = x.set("c", 3);
		assertThat(y, is(Index.of("a", 1).set("b", 2)));
		assertThat(z, is(Index.of("a", 1).set("c", 3)));
	}
	...
	public void shouldNotStackOverflowWhenAppendingManyElements()
	{
		...
		for(int i = 0; i < stackSize; i++) x = x.set(Integer.toString(i), i);
	...
	{
		final Index<String, Integer> x = Index.of("a", 1);
		final Index<String, Integer> y = x.set("a", 2);
		assertThat(x.get("a").get(), is(1));
	...
	{
		final Index<String, Integer> x = Index.of("a", 1);
		final Index<String, Integer> y = x.set(Pair.of("b", 2));
		assertThat(y.get("a").get(), is(1));
		assertThat(y.get("b").get(), is(2));
		assertFalse(x.containsKey("b"));
	}
	...
	{
		final Index<String, Integer> x = Index.of("a", 1).set("b", 2);
		final Index<String, Integer> y = Index.of("b", 7).set("c", 8).set("d", 9);
		final Index<String, Integer> z = x.setAll(y);
	...
	{
		final Index<String, Integer> x = Index.of("a", 1).set("b", 2).set("c", 2);
		final Index<Integer, String> y = x.flip((first, second) -> first);
		assertThat(y, is(Index.of(1, "a").set(2, "b")));
	}
	...
	public void shouldFlipWithLatterEntriesSurviving()
	{
		...
		assertThat(y, is(Index.of(1, "a").set(2, "c")));
	}
